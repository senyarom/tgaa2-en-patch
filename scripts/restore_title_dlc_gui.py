#!/usr/bin/env python3
"""Re-enable the TGAA1/TGAA2 DLC panel without rebuilding its animations.
...
def property_layout(data: bytes | bytearray) -> tuple[int, int]:
    ...
    rebuilt files use an extended 20-byte form; depending on the game/build,
    the property array may also have a four-byte prefix and suffix. Node
    property indices are unchanged.
    """
